...
def main():
    ...
    #training('manon-expe-'+expenum+'.conf')
    pyllar.splash("Appuyez sur une touche pour commencer l'experience.")
    expe('manon-expe-'+expenum+'.conf','manon-expe-'+expenum+'-resultats.res')
